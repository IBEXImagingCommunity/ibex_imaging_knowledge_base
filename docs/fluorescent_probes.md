...
Results are reported for the original IBEX2D Manual method that uses 1 mg/ml of LiBH4. The time, concentration of LiBH4, and method (continuous exchange, bleaching in the presence of light) may vary by IBEX configuration or user.
