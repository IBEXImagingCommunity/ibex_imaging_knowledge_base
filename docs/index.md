...
<table style="margin-left: auto;margin-right: auto; border: 2px solid purple; border-radius: 20px;">
    <tbody>
        <tr>
            ...
            <td style="text-align:center"><p style="font-family:verdana;font-size:xx-large">504</p></td>
            <td style="text-align:center"><p style="font-family:verdana;font-size:xx-large">166</p></td>
...
<p float="middle">
  <img alt= "National Institute of Allergy and Infectious Diseases Logo" src="https://github.com/IBEXImagingCommunity/ibex_imaging_large_files/raw/main/docs/National_Institute_of_Allergy_and_Infectious_Diseases_Logo.svg" width="30%"/>&emsp; 
  <img alt="National Cancer Institute Logo" src="https://github.com/IBEXImagingCommunity/ibex_imaging_large_files/raw/main/docs/National_Cancer_Institute_Logo.svg" width="25%"/>&emsp;<img alt=" Schroeder Allergy and Immunology Research Institute Logo" src="https://github.com/IBEXImagingCommunity/ibex_imaging_large_files/raw/main/docs/Schroeder_Allergy_and_Immunology_Research_Institute.svg" width="39%"/><br> 
  <img alt="Chan Zuckerberg Initiative Logo" src="https://github.com/IBEXImagingCommunity/ibex_imaging_large_files/raw/main/docs/Chan_Zuckerberg_Initiative_Logo.svg" width="20%"/>&emsp; 
  <img alt="Wellcome Trust Logo" src="https://github.com/IBEXImagingCommunity/ibex_imaging_large_files/raw/main/docs/Wellcome_Trust_Logo.svg" width="12%"/><br>
</p>

---

Banner created by Autumn Yarmosh and David M. Sullivan.
